...
if(isset($_GET['id'])) {
    ...
    $stm = $conexion -> prepare("SELECT * FROM programacion WHERE id=:txtid");
...
$stm = $conexion -> prepare("UPDATE programacion SET nombre=:nombre,cedula=:cedula,correo=:correo,telefono=:telefono,direccion=:direccion,fecha=:fecha WHERE id=:txtid");
