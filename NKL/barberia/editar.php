...
if(isset($_GET['id'])) {
    ...
    $stm = $conexion -> prepare("SELECT * FROM barberia WHERE id=:txtid");
...
$stm = $conexion -> prepare("UPDATE barberia SET nombre=:nombre,cedula=:cedula,correo=:correo,telefono=:telefono,direccion=:direccion,fecha=:fecha WHERE id=:txtid");
        ...
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    ...
                    <h2 class="text-center text-white fw-bold">Modificar Tabla:</h2>
